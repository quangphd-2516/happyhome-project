...
const mockAuctions = [
    ...
    },
    {
        ...
        title: 'Premium Penthouse Auction',
    ...
    },
    {
        ...
        title: 'Beachfront Property Auction',
    ...
    },
    {
        ...
        title: 'Prime Location Shophouse',
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600">
                            Manage and monitor all property auctions
                        </p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl shadow-xl p-8 text-white">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-green-100 text-sm font-medium mb-2">Total Auction Revenue</p>
                            <p className="text-5xl font-bold">{formatCurrency(stats.totalRevenue)}</p>
                            <p className="text-green-100 text-sm mt-2">From completed auctions</p>
                        </div>
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20">
                            ...
                            <p className="text-gray-600 text-center max-w-md mb-6">
                                No auctions match your filters. Try adjusting your search criteria or create a new auction.
                            </p>
                            <button
                                onClick={handleCreateAuction}
